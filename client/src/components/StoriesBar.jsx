  ...
  return (
    ...
    overflow-x-auto px-4'>
      <div className='flex gap-4 pb-5'>
        ...
        {/* Add a story card */}
        <div onClick = {()=>setShowModel(true)} className='rounded-lg shadow-sm min-w-[120px] max-w-[120px] max-h-[160px] aspect-[3/4] cursor-pointer hover:shadow-lg transition-all duration-200
        ...
        {stories.map((story, index) => (
          <div onClick={()=> setViewStory(story)}
            ...
            min-w-[120px] max-w-[120px] max-h-[160px]
          ...
          >
            <img
              ...
              alt=""
              className='absolute size-8 top-3 left-3 z-20 rounded-full
              ring ring-gray-100 shadow'
            />

            <p className='absolute top-18 left-3 z-20 text-white/60 text-sm
            truncate max-w-24'>
              {story.content}
            </p>
